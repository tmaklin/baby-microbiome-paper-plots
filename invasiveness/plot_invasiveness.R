...
plotting.data.st131 <- plotting.data[c(12:1, 15, 13, 14), ]
...
## png(file = "invasiveness_vs_carriage.png", width = 1600, height = 1000, pointsize = 40)
## layout(matrix(c(1, 2, 3, 3), byrow = TRUE, nrow = 2, ncol = 2), height = c(6, 1))
## par(mar = c(4.5, 4, 0.5, 2.5))
## PlotInvasiveness(plotting.data.all)
## par(mar = c(4.5, 6, 0.5, 0.5))
...
## par(mar = c(0, 0, 0, 0))
## plot(0, bty ='n', xaxt='n', yaxt='n', xlab='', ylab='', pch = '')
## legend("top", legend = c("Odds ratio", "95% confidence interval", "", "Invasive", "Intermediate", "Commensal"), col = c("black", "black", "black", "#d73027", "gray80", "#92c5de"), bty = 'n', lty = c(NA, 1, NA, 1, 1, 1), lwd = c(NA, 2, NA, 4, 4, 4), pch = c(19, NA, NA, NA, NA, NA), ncol = 2)
## dev.off()
