...
pdf(file = "E_faecalis_transition_matrix.pdf", width = 9, height = 8)
...
par(mar = c(0, 6, 8, 1))
PlotTransitionMatrix(caesarean.mats$no_mother_no_infancy, "b)", 0.565, -5, nrow(caesarean.mats$no_mother_no_infancy) + 2, n.max, 0.4, gradient)
par(mar = c(10, 8, 8, 2))
...
par(mar = c(1, 0, 8, 4))
IntensityLegend(gradient, n.max, -45)
